...
def main():
    ...
    plot_variants = [
        ("unsorted_boxplot", (list(boxplot_data.items())), "Unsorted Boxplot: Magnitude Distribution"), #reversing creates an iterator that can only be used once. need to convert it to list so it can be outputed to html and csv.
